# Tokico Blockchain Stats

Tokico Blockchain Stats utlity exports daily statistics for the tokico blockchain from creation through current state.

## Usage:

See also the utility's help option. `tokico-blockchain-stats --help`
...
- `tokico-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `tokico-blockchain-stats | save-to-database.sh`
