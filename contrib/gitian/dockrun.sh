...
RUN	git clone https://github.com/tokico-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/tokico-project/tokico
...
if [ ! -d sigs ]; then
	git clone https://github.com/tokico-project/gitian.sigs.git sigs
	cd sigs
