...
*Setup instructions for a Gitian build of Tokico using Docker.*
...
You'll also need to clone the tokico repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/tokico-project/tokico.git
cd tokico/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/tokico-project/gitian.sigs/) repo on your GitHub account.
